...
void quadcopter::main(void) {
	...
	waiting_time = waiting_time + ((double)36 * 4 * 2);
	...
	waiting_time = waiting_time + ((double)20 * 4 * 2);

#line 93 "./quadcopter.sc"
	...
	waiting_time = waiting_time + ((double)24 * 4 * 2);

#line 121 "./quadcopter.sc"
	waiting_time = waiting_time + ((double)130 * 4 * 2);

#line 129 "./quadcopter.sc"
	waiting_time = waiting_time + ((double)18 * 4 * 2);

#line 137 "./quadcopter.sc"
	waiting_time = waiting_time + ((double)20 * 4 * 2);

#line 144 "./quadcopter.sc"
