...
#line 30 "./quadcopter.sc"
    const unsigned long int MAX_SIZE;

#line 42 "./quadcopter.sc"
    double accel_data; double gps_data; double gyro_data; double lidar_data;

#line 41 "./quadcopter.sc"
    unsigned int pitch;
    double position_data;

#line 41 "./quadcopter.sc"
    unsigned int roll; unsigned int throttle;
    double waiting_time;

#line 41 "./quadcopter.sc"
    unsigned int yaw;

#line 31 "./quadcopter.sc"
